...
image: /locustec/new_site-nuclear.png
header-image: /locustec/new_header-collage-light.png
---
...
{% include project-image.html file="locustec/old_site-3-screens.png" description="The previous website was built almost entirely with static HTML files.  There was no CMS, so updates essentially required the help of someone with basic front-end development skills." %}
...
{% slider 400 [bullets] [captions] %}
  ![Information architecture spreadsheets]({{ "/assets/locustec/IA-spreadsheet-01.png" | absolute_url }})
  ![Information architecture spreadsheets]({{ "/assets/locustec/IA-spreadsheet-02.png" | absolute_url }})
  ![Information architecture spreadsheets]({{ "/assets/locustec/IA-spreadsheet-03.png" | absolute_url }})
{% endslider %}
...
{% include project-image.html file="locustec/mgmt_locustec-trello.png" description="This was the start of a beautiful and prosperous relationship between Trello and me." %}
...
{% slider 400 [bullets] [captions] %}
  ![With heatmap tracking and recordings, we can identify problem areas & opportunities.]({{ "/assets/locustec/analytics_heatmap-footer2.png" | absolute_url }})
  ![We use Google Analytics and WebCEO to monitor site rankings and other trends.]({{ "/assets/locustec/analytics_GA-social referrals.png" | absolute_url }})
{% endslider %}
