...
<p>It was in dire need of a major, structural overhaul to make it easier for employees in various departments to add and update content, to improve SEO, to track and improve lead generation, to better address our primary customer segments through rich, targeted content, and to promote the company as an industry leader.</p>
<p>Through research and coordination of a talented, cross-department team, I crafted and implemented a strategy to redesign and rebuild the website with a special focus on IA analysis and reorganization, comprehensive content strategy, UX research and design, and an integrated, ongoing analytics plan.</p>
{% endcapture %}
...
In 2015, Locus Technologies' website was simply "existing".  It was built with static HTML files and a bit of Perl for its forms (no CMS, no dynamic content).  The marketing team added new content to it periodically, such as press releases or blog posts, but no one would honestly claim that the website was doing anything in the way of lead generation.  Everyone was aware of a number of issues that needed attention:
...
Before even thinking about possible new approaches to design or content, I created a sitemap of the existing content.  This provided painful proof to all stakeholders that the site had heaps of duplicate and misplaced content.

Throughout the project, the sitemap would prove to be an important tool to refine and organize the content we needed to share—and to identify what was only serving the desires of the company and just wasn’t important to our users.
